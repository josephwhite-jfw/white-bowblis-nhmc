---
title: "TWFE HPPD Results — Levels & Logs (Split Tables)"
author: "Joe White"
...
fixest::etable(
  ...
  depvar       = FALSE,
  drop.section = "fixef",
  title        = "Two-Way FE OLS — With Anticipation (Levels)"
)
```
...
fixest::etable(
  ...
  depvar       = FALSE,
  drop.section = "fixef",
  title        = "Two-Way FE OLS — With Anticipation (Logs)"
)
```
...
fixest::etable(
  ...
  depvar       = FALSE,
  drop.section = "fixef",
  title        = "Two-Way FE OLS — Excluding Anticipation (Levels)"
)
```
...
fixest::etable(
  ...
  depvar       = FALSE,
  drop.section = "fixef",
  title        = "Two-Way FE OLS — Excluding Anticipation (Logs)"
)
